...
class sellerloginMedium extends StatefulWidget {
  const sellerloginMedium({Key? key}) : super(key: key);

  @override
  State<sellerloginMedium> createState() => _sellerloginMediumState();
}

class _sellerloginMediumState extends State<sellerloginMedium> {
