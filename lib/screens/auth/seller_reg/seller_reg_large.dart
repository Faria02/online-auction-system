...
class sellerRegLarge extends StatefulWidget {
  const sellerRegLarge({Key? key}) : super(key: key);

  @override
  State<sellerRegLarge> createState() => _sellerRegLargeState();
}

class _sellerRegLargeState extends State<sellerRegLarge> {
