...
class sellerForgotPassLarge extends StatefulWidget {
  const sellerForgotPassLarge({Key? key}) : super(key: key);

  @override
  State<sellerForgotPassLarge> createState() => _sellerForgotPassLargeState();
}

class _sellerForgotPassLargeState extends State<sellerForgotPassLarge> {
