...
class buyerForgotPassMedium extends StatefulWidget {
  const buyerForgotPassMedium({Key? key}) : super(key: key);

  @override
  State<buyerForgotPassMedium> createState() => _buyerForgotPassMediumState();
}

class _buyerForgotPassMediumState extends State<buyerForgotPassMedium> {
