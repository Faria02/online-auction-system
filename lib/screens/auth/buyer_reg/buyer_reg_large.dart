...
class buyerRegLarge extends StatefulWidget {
  const buyerRegLarge({Key? key}) : super(key: key);

  @override
  State<buyerRegLarge> createState() => _buyerRegLargeState();
}

class _buyerRegLargeState extends State<buyerRegLarge> {
